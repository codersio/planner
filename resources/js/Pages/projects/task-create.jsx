...
const TaskCreate = ({ employees, projects, taskcategory, user, user_type, notif }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const projectEstimateTime = parseFloat(selectedProject.estimate_time);
                    ...
                    {data.employee_id.length > 0 && (
                        <div className="col-span-2">
                            {data.employee_id.map((employeeId) => (
                                <div key={employeeId}>
                                    <label htmlFor={`employee_hours_${employeeId}`}>
                                        Hours for {employees.find(emp => emp.id === employeeId)?.name}
                                    </label>
                                    <input
                                        className="w-full rounded-lg"
                                        type="number"
                                        ...
                                        value={data.employee_hours[employeeId] || ''}
                                        onChange={(e) => handleEmployeeHoursChange(employeeId, e.target.value)}
                                    />
                                </div>
                            ))}
                        </div>

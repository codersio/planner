...
const Edit = ({ employee,user,user_type ,roles,employeeRole}) => {
            ...
            <div className='p-3 table-section'>
                ...
                <form onSubmit={handleSubmit} className='px-[8rem] grid grid-cols-2 gap-4'>
                    ...
                    <div>
                        ...
                        <input className='w-full rounded-lg' id="password" name='password' type="password" value={data.password} onChange={handleChange}  />
                    </div>
                    <div>
                    ...
                    <div>
                       ...
                       <select  className='w-full rounded-lg' name="roleemployee" id="" value={data.roleemployee || employeeRole} onChange={handleChange}>
